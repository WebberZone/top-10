...
- Commit messages: never include a `Co-Authored-By:` line or a `Claude-Session:` line. A commit message ends with its body.
- Pull request bodies, issue comments and review comments: no "Generated by Claude Code" footer or any equivalent.
