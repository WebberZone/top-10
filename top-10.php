...
if (! function_exists(__NAMESPACE__ . '\\autoload') ) {
    include_once plugin_dir_path(__FILE__) . 'includes/autoloader.php';
}
...
if (! function_exists('tptn_get_settings') ) {
    include_once plugin_dir_path(__FILE__) . 'includes/options-api.php';
    include_once plugin_dir_path(__FILE__) . 'includes/wz-pluggables.php';
    include_once plugin_dir_path(__FILE__) . 'includes/class-top-ten-query.php';
