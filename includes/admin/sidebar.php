...
<div class="postbox-container">
	...
	<div id="qlinksdiv" class="postbox meta-box-sortables">
	  ...
	  <div class="inside">
		<div id="quick-links">
			<ul>
				<li><a href="https://webberzone.com/plugins/top-10/"><?php esc_html_e( 'Top 10 plugin homepage', 'top-10' ); ?></a></li>
				<li><a href="https://wordpress.org/plugins/top-10/faq/"><?php esc_html_e( 'FAQ', 'top-10' ); ?></a></li>
				<li><a href="http://wordpress.org/support/plugin/top-10"><?php esc_html_e( 'Support', 'top-10' ); ?></a></li>
				<li><a href="https://wordpress.org/support/view/plugin-reviews/top-10"><?php esc_html_e( 'Reviews', 'top-10' ); ?></a></li>
				<li><a href="https://github.com/WebberZone/top-10"><?php esc_html_e( 'Github repository', 'top-10' ); ?></a></li>
				<li><a href="https://webberzone.com/plugins/"><?php esc_html_e( 'Other plugins', 'top-10' ); ?></a></li>
				<li><a href="https://ajaydsouza.com/"><?php esc_html_e( "Ajay's blog", 'top-10' ); ?></a></li>
			</ul>
		</div>
	  </div><!-- /.inside -->
	</div><!-- /.postbox -->
