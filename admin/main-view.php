					...
					<tr><th scope="row"><label for="thumb_html"><?php _e( 'Image size attributes:', 'top-10' ); ?></label></th>
						<td>
							<label>
								...
								<?php _e( 'Style attributes are used for width and height.', 'top-10' ); echo ' <code>style="max-width:' . $tptn_settings['thumb_width'] . 'px;max-height:' . $tptn_settings['thumb_height'] . 'px;"</code>'; ?>
							</label>
							<br />
							<label>
								<input type="radio" name="thumb_html" value="html" id="thumb_html_1" <?php if ( 'html' == $tptn_settings['thumb_html'] ) echo 'checked="checked"' ?> />
								<?php _e( 'HTML width and height attributes are used for width and height.', 'top-10' ); echo ' <code>width="' . $tptn_settings['thumb_width'] . '" height="' . $tptn_settings['thumb_height'] . '"</code>'; ?>
							</label>
							<br />
							<label>
