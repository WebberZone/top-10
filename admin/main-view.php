			...
			<div class="inside">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<label><input type="checkbox" name="add_to_content" id="add_to_content" <?php if ( $tptn_settings['add_to_content'] ) { echo 'checked="checked"'; } ?> /> <?php esc_html_e( 'Posts', 'top-10' ); ?></label><br />
							<label><input type="checkbox" name="count_on_pages" id="count_on_pages" <?php if ( $tptn_settings['count_on_pages'] ) { echo 'checked="checked"'; } ?> /> <?php esc_html_e( 'Pages', 'top-10' ); ?></label><br />
							<label><input type="checkbox" name="add_to_home" id="add_to_home" <?php if ( $tptn_settings['add_to_home'] ) { echo 'checked="checked"'; } ?> /> <?php esc_html_e( 'Home page', 'top-10' ); ?></label></label><br />
							<label><input type="checkbox" name="add_to_feed" id="add_to_feed" <?php if ( $tptn_settings['add_to_feed'] ) { echo 'checked="checked"'; } ?> /> <?php esc_html_e( 'Feeds', 'top-10' ); ?></label></label><br />
					...
					<tr>
						...
						<td>
					    	...
					    	<p class="description"><?php esc_html_e( 'Disabling this option will stop authors visits tracked on their own posts', 'top-10' ); ?></p>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="track_admins"><?php esc_html_e( 'Track visits of admins?', 'top-10' ); ?></label></th>
						<td>
							<input type="checkbox" name="track_admins" id="track_admins" <?php if ( $tptn_settings['track_admins'] ) { echo 'checked="checked"'; } ?> />
							<p class="description"><?php esc_html_e( 'Disabling this option will stop admin visits being tracked.', 'top-10' ); ?></p>
						</td>
					</tr>
					<tr>
						<th scope="row"><label for="track_editors"><?php esc_html_e( 'Track visits of Editors?', 'top-10' ); ?></label></th>
						<td>
							<input type="checkbox" name="track_editors" id="track_editors" <?php if ( $tptn_settings['track_editors'] ) { echo 'checked="checked"'; } ?> />
					    	<p class="description"><?php esc_html_e( 'Disabling this option will stop editor visits being tracked.', 'top-10' ); ?></p>
						</td>
					</tr>
					<tr>
	    ...
	    <div id="thumbopdiv" class="postbox"><div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'top-10' ); ?>"><br /></div>
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr><th scope="row"><label for="thumb_crop"><?php esc_html_e( 'Crop mode:', 'top-10' ); ?></label></th>
						<td>
