	    ...
	    <div id="genopdiv" class="postbox"><div class="handlediv" title="<?php _e( 'Click to toggle', TPTN_LOCAL_NAME ); ?>"><br /></div>
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr><th scope="row"><label for="show_metabox"><?php _e( "Show metabox:", TPTN_LOCAL_NAME ); ?></label></th>
						<td>
							<input type="checkbox" name="show_metabox" id="show_metabox" <?php if ( $tptn_settings['show_metabox'] ) echo 'checked="checked"' ?> />
							<p class="description"><?php _e( 'This will add the Contextual Related Posts metabox on Edit Posts or Add New Posts screens. Also applies to Pages and Custom Post Types.', TPTN_LOCAL_NAME ); ?></p>
						</td>
					</tr>

					<tr><th scope="row"><label for="show_metabox_admins"><?php _e( "Limit metabox to Admins only:", TPTN_LOCAL_NAME ); ?></label></th>
						<td>
							...
							<p class="description"><?php _e( 'If this is selected, the metabox will be hidden from anyone who is not an Admin. Otherwise, by default, Contributors and above will be able to see the metabox. This applies only if the above option is selected.', TPTN_LOCAL_NAME ); ?></p>
						</td>
					</tr>
